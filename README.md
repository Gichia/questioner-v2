...
# Badges
[![Build Status](https://travis-ci.org/Gichia/questioner-v2.svg?branch=develop)](https://travis-ci.org/Gichia/questioner-v2)
[![Coverage Status](https://coveralls.io/repos/github/Gichia/questioner-v2/badge.svg?branch=develop)](https://coveralls.io/github/Gichia/questioner-v2?branch=develop)
[![Maintainability](https://api.codeclimate.com/v1/badges/da29ffd48f9e4fab39fa/maintainability)](https://codeclimate.com/github/Gichia/questioner-v2/maintainability)
