...
class TestUsers(BaseTest):
    ...
    def test_user_signup(self):
        ...
        self.assertEqual(result_2["message"], "Please provide correct details")
        self.assertEqual(result_3["message"], "Please provide your lastname!")

        self.delete_email("ken2@gmail.com")
